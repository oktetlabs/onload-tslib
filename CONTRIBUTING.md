...
# Contributing code to Onload Test Suite library

The document provides the guidelines for submitting changes to Onload TS library.
...
The summary line should:
 ...
 - start with the imperative of a verb, for example:
   ...
   ```
   lib/ts: allow to disable writing to the serial console
   ```
